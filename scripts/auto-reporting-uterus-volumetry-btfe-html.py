...
def generate_all_measurements(input_lab_matrix, voxel_dims, ga):
    measurements = {
        "Amniotic Fluid Volume [cc]": (4, -1, -1, -1, -1, -1.6525,  98.534, -851.15, -0.5451, 38.784, -430.84, "Amniotic Fluid Volume"),
        "Placenta Volume [cc]": (2, -1, -1, -1, -1, -0.091, 41.116, -507.49, -0.2115, 16.766, -178.57, "Placenta Volume"),
        "Fetal Volume [cc]": (1, 5, -1, -1, -1,  4.4677, -107.26, 614.58, 0.6207, -20.43, 194.32, "Fetal Volume")
    }
...
<head>
    ...
    <title>BTFE Fetal MRI: Automated Uterus Volumetry Report</title>
...
<body>
    <h1>BTFE Fetal MRI: Automated Uterus Volumetry Report</h1>
    <div class="container">
