...
echo "-----------------------------------------------------------------------------"
echo
echo "SVRTK for fetal MRI (KCL): auto brain BET segmentation for 3D SVR SSTSE / HASTE T2w fetal MRI"
...
if [[ $# -ne 2 ]] ; then
    echo "Usage: bash /home/auto-proc-svrtk/scripts/auto-brain-bet-segmentation-fetal.sh"
