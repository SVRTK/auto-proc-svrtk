...
if [ $# -ne 2 ] ; then
    ...
    if [ $# -ne 6 ] ; then
        echo "Usage: bash /home/auto-proc-svrtk/scripts/auto-thorax-reconstruction-2026.sh"
...
do
    ...
    ${mirtk_path}/mirtk extract-label out-reo-masks/reo-mask-${jj}.nii.gz l${q}.nii.gz 1 2 
...
${mirtk_path}/mirtk stacks-and-masks-selection-2026 selected-template.nii.gz selected-mask.nii.gz recon-files 40 1200 ${number_of_stacks} proc-files/org-stack-*.nii.gz proc-files/org-thorax-mask-*.nii.gz proc-files/d-*.dof
