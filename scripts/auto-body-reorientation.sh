...
if [[ $# -ne 5 ]] ; then
   ...
   if [[ $# -ne 2 ]] ; then
 	...
 	echo "Usage: bash /home/auto-proc-svrtk/scripts/auto-body-reorientation.sh"
...
current_monai_check_path=${segm_path}/trained_models/monai-checkpoints-unet-stack-body-reo-4-lab
...
do
    ...
    ${mirtk_path}/mirtk extract-label ${all_masks[$i]} global-masks/mask-${jj}.nii.gz 1 2 
