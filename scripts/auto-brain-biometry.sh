...
#    echo $z
    ...
    ${mirtk_path}/extract-connected-components ${proc}/m.nii.gz ${proc}/m.nii.gz -v 0 > ${proc}/tmp.txt
...
${mirtk_path}/transform-image ${proc}/repl-res-org-${s}-bio-lab.nii.gz ${bio} -target ${res_reo_t2} -labels
