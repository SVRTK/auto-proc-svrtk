...
if [ $# -ne 2 ] ; then
    ...
    if [ $# -ne 6 ] ; then
        echo "Usage: bash /home/auto-proc-svrtk/scripts/auto-brain-reconstruction-2026.sh"
...
do
    ...
    res=128 ; lab_num=1 ;
    current_monai_check_path=${model_path}/monai-2026/at_unet_bet_brain_153t_stacks_2026_128_best_metric_model.pth
    ...
    ${mirtk_path}/mirtk crop-image ${all_org_stacks[$i]} out-global-masks/mask-${jj}.nii.gz res-crop-stacks/crop-stack-${jj}.nii.gz
    ...
    ${mirtk_path}/mirtk mask-image res-crop-stacks/crop-stack-${jj}.nii.gz out-global-masks/mask-${jj}.nii.gz res-crop-stacks/crop-stack-${jj}.nii.gz
    ${mirtk_path}/mirtk pad-3d res-crop-stacks/crop-stack-${jj}.nii.gz res-crop-stacks/crop-stack-${jj}.nii.gz 128 1 

    res=128 ; lab_num=5 ;
    current_monai_check_path=${model_path}/monai-2026/at_unet_reo_brain_5lab_global_full_rois_153t_v3_2026_128_best_metric_model.pth
