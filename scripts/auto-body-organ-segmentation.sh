...
if [[ $# -ne 2 ]] ; then
    echo "Usage: bash /home/auto-proc-svrtk/scripts/auto-body-organ-segmentation.sh"
...
python3 ${segm_path}/src/run_monai_unet_segmentation-2022.py ${main_dir}/ ${monai_check_path_body_global_unet}/ stack-info.json ${main_dir}/monai-segmentation-results-body_global ${res} ${monai_lab_num}
...
do
    ...
    ${mirtk_path}/mirtk erode-image dl.nii.gz dl.nii.gz -iterations 3
    ${mirtk_path}/mirtk mask-image ${all_stacks[$i]} dl.nii.gz masked-stacks/masked-stack-${jj}.nii.gz
#    ${mirtk_path}/mirtk N4 -i masked-stacks/masked-stack-${jj}.nii.gz -x dl.nii.gz -o tmp.nii.gz  -c "[50x50x50,0.001]" -s 2 -b "[100,3]" -t "[0.15,0.01,200]" > t.txt
...
python3 ${segm_path}/src/run_monai_unet_segmentation-2022.py ${main_dir}/ ${monai_check_path_body_organ_unet}/ masked-stack-info.json ${main_dir}/monai-segmentation-results-body_organ ${res} ${monai_lab_num}
