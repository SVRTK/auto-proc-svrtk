...
fl_segmentation_inputs_0 = final_image.unsqueeze(0).to(device)
fl_segmentation_inputs_0 = flp_run_0(fl_segmentation_inputs_0)

fl_segmentation_inputs_1 = final_image.unsqueeze(0).to(device)
fl_segmentation_inputs_1 = flp_run_1(fl_segmentation_inputs_1)

fl_segmentation_inputs_2 = final_image.unsqueeze(0).to(device)
fl_segmentation_inputs_2 = flp_run_2(fl_segmentation_inputs_2)
...
with torch.no_grad():
    ...
    fl_segmentation_output_0 = segmentation_model(fl_segmentation_inputs_0)
    fl_segmentation_output_1 = segmentation_model(fl_segmentation_inputs_1)
    fl_segmentation_output_2 = segmentation_model(fl_segmentation_inputs_2)
    
    fl_segmentation_output_final_0 = flp_run_0(fl_segmentation_output_0.clone())
    fl_segmentation_output_final_1 = flp_run_1(fl_segmentation_output_1.clone())
    fl_segmentation_output_final_2 = flp_run_2(fl_segmentation_output_2.clone())
    
    sum_segmentation_outputs = (segmentation_output.clone() + fl_segmentation_output_final_0.clone()  + fl_segmentation_output_final_1.clone()   + fl_segmentation_output_final_2.clone()) / 4.0
